...
SegmentDynObject::SegmentDynObject(){
    ...
    PyObject* pModule = PyImport_ImportModule(this->module_name.c_str());
...
//    this->py_class = PyObject_GetAttrString(this->py_module, this->class_name.c_str());
    PyObject* py_class = PyDict_GetItemString(pDict, "Mask");
    std::cout << "1!" << std::endl;
//    assert(this->py_class != NULL);
    std::cout << "2" << std::endl;
//    this->net = PyInstance_New(this->py_class, NULL, NULL);
    this->net = PyInstance_New(py_class, NULL, NULL);
